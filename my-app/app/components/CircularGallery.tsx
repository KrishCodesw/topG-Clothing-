...
const localItems = [
  { image: "/hero1.png", text: "" },
  { image: "/hero2.png", text: "" },
  { image: "/hero3.png", text: "" },
  { image: "/hero4.png", text: "" },
  { image: "/hero5.png", text: "" },
  { image: "/hero6.png", text: "" },
];
...
export default function CircularGallery({
  ...
  useEffect(() => {
    // Function to check if we're on mobile (width threshold, e.g., 768px)
  ...
  return (
    <div
      className={
        isMobile
          ? "circular-gallery-container cursor-grab active:cursor-grabbing"
